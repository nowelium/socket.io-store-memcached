...
function Memcached (opts) {
  ...
  this._pubsub = new MemcachedPubSub(new memcached(opts.hosts, opts), nodeId);
...
function Client (store, id) {
  ...
  this._keyList = new MemcachedList(this.store._client, id);
  this._map = new MemcachedMap(this.store._client, id);
};
